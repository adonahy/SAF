		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <a href="bancos.php">Alumnos</a>
                    <i class="icon-angle-right"></i>
                    <a href="manto_cxp.php">Pagos de Alumnos</a>
                    <!--<i class="icon-angle-right"></i>
                    <a href="#">Gasto proveedores</a>-->
                </li>
			</ul>
                <?php
                if($security == 'go'){ 
                ...
                if(empty($_POST)===false && $_POST['flag1']=="guardar"){
                    ...
                    $query2 =   mysql_query("INSERT INTO `cxp` (`id_control`, `fecha`, `no_docto`, `serie`, `proveedor`, `archivo`, `descripcion`, `total`, `saldo`, `estatus`) VALUES (NULL, '$da', '$no_docto', '$serie', '$id_proveedor', '$new_file_name', '$descrip', '$total', '$total', '0')");
						  ...
						  <fieldset>
                            <div class="control-group">
                             ...
                             <label class=" control-label" for="no_documento">NO. DOCUMENTO: </label>
								...
								<label class="control-label" for="proveedor">ALUMNO: </label>
								<div class="controls">
								  <select id="proveedor" name="proveedor" data-rel="chosen">
                                      <option value=""></option>
                                    <?php
                                      $query1=mysql_query("SELECT `id_alumno`,`nombres`, `apellidos` FROM `alumno` ORDER BY id_alumno ASC");
                                    ...
                                    ?>
                                      <option value="<?php echo "$id_alumno";?>"><?php echo $apellidos . ", " . $nombres;?></option>
                                    <?php
                                      }
                                    ?>
                            ...
                            <label class=" control-label" for="tot_factura">TOTAL PAGO: </label>
                              <div class="controls">
								...
								<input type="text" class="input-medium typeahead" id="descripcion" name="descripcion" value="" >
							  </div>   
							</div>
