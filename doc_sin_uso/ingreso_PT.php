...
<?php
                ...
                if(empty($_POST)===false){
                    ...
                    $query      =   mysql_query("INSERT INTO `ingreso_pt` (`id`, `fecha`, `no_docto`, `cliente`, `no_orden`, `codigo`, `descripcion`, `cantidad`) VALUES (NULL, '$fecha', '$no_docto', '$cliente', '$no_orden', '$codigo', '$descripcion', '$cantidad')");
                    ...
                    $d      =   "Efectuo un ingreso de inventario en el codigo: " . $codigo . " por una cantidad de: ";
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
                ...
                <?php
                    if($security == 'go'){ 
                    if($monica=="yes"){
                        echo "<h3>Ingreso realizado exitosamente!</h3>";
                    }
                ?>
						  ...
						  <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label" for="n_orden_produccion">No. Orden Producción: </label>
                                  <div class="controls">
								<input type="text" class="span6 typeahead" id="n_orden_produccion" name="n_orden_produccion" placeholder="Ingresar el número de orden de producción..." >
                                </div><br>
								...
								<input type="text" class="span6 typeahead" id="des" name="des" placeholder="Este campo sera llenado automaticamente..." >
                                  ...
                                  <div class="controls">
								<input type="text" class="span6 typeahead" id="cantidad" name="cantidad" placeholder="Ingresar la cantidad..." >
                                </div><br>
