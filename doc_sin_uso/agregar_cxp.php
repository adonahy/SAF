		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
                ...
                if(empty($_POST)===false && $_POST['flag1']=="guardar"){
                    ...
                    $query2 =   mysql_query("INSERT INTO `cxp` (`id_control`, `fecha`, `no_docto`, `serie`, `proveedor`, `archivo`, `total`, `saldo`, `estatus`) VALUES (NULL, '$da', '$no_docto', '$serie', '$id_proveedor', '$new_file_name', '$total', '$total', '0')");
