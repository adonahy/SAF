...
$proveedort_length  = strlen($proveedort);
$esta              = strpos("$proveedort", "-");

$idproveedor      = substr($proveedort,0,$esta);
$pos               = $esta + 1;
$nombreproveedor  = substr($proveedort,$pos,$proveedort_length);



$query1  =   mysql_query("SELECT * FROM `cxp` WHERE proveedor = '$idproveedor' ");
...
$query  =   mysql_query("SELECT * FROM `cxp_abonos` WHERE control = '$idcpx' ORDER BY `fecha` ASC");
    ...
    $val=$val . "
                <tbody>
                    <tr>
				        ...
				        <td class=\"center\"> $noabono </td>
				        <td class=\"center\"> $fpago </td>  
                        <td class=\"center\"> $total </td>
                        <td class=\"center\"> $abono </td>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
                <h1>Estado de cuenta por proveedores</h1>
                <div class="box-content">
						<form class="form-horizontal">
						  <fieldset>
							  ...
							  <label class="control-label" for="typeahead">Nombre de proveedor: </label>
							  <div class="controls">
								<input type="text" class="span46 typeahead" id="banco" name="banco" value="'. $nombreproveedor .'">
							  </div>
							</div>
