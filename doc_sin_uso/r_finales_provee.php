...
$query  = mysql_query("SELECT `id_control`,`fecha`,`no_docto`,`serie`,`proveedor`,`total`,`saldo` FROM `cxp` WHERE fecha >= '$del' AND fecha <= '$al' ");
...
$query1 = mysql_query("SELECT `nombre_proveedor`,`id_proveedor` FROM `proveedores` WHERE id_proveedor = '$proveedor' ");
$r1 = mysql_fetch_array($query1);

$proveedor_nombre = $r1['nombre_proveedor'];
...
$query3 = mysql_query("SELECT `id`,`control`,`cantidad`,`no_doc`,`forma_pago` FROM `cxp_abonos` WHERE control = '$idcxp' ");
...
while($r3=mysql_fetch_array($query3)){
   ...
   // $idcontrol  = $r3['id_control'];
    //$serie      = $r3['serie'];
    //$abono      = $abono + $r3['cantidad'] ;
    $fpago      = $fpago . $r3['forma_pago'] . ", ";
    $doctos     = $doctos . $r3['no_doc'] . ", ";
    
    //$abono_tot  = $abono_tot + $r3['cantidad'];
     ...
     $val=$val . "
                <tbody>
                    <tr>
                        ...
                        <td class=\"center\"> $proveedor_nombre </td>
...
$mpdf->Output('Proveedores_todo.pdf', 'D');
