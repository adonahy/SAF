		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="rep_bancos.php">Bancos</a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Egresos</a>
                </li>
			</ul>
                <?php if($security == 'go'){ ?>
                <h1>Reporte de Egreso a Bancos</h1>
                <div class="box-content">
						<form class="form-horizontal" action="rep_egreso_conta.php" method="post">
						  <fieldset>
                              <h2>Fecha</h2> <br>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <select id="razon" name="razon" data-rel="chosen">
                                      ...
                                      <option value="Chequesrecha">Cheques rechazados</option>
                                      <!--<option value="Notadedebito">Nota de debito</option>-->
								  </select>
								</div>
							  </div>
