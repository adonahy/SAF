		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="#">Ingreso de lista de área</a>
                </li>
			</ul>
                <?php
                if($security == 'go'){
                if(empty($_POST)===false){
                        ...
                        $query=mysql_query("INSERT INTO `area` (`id_area`,`descripcion_area`) VALUES (NULL, '$des')");
                        
                        insert_logs($da, $u, $d, $t, $des);
                        echo "<h3>Área de trabajo ingresada con éxito!</h3>";
                    }
                
                ?>
                <h1>Mantenimiento de áreas de trabajo</h1>
