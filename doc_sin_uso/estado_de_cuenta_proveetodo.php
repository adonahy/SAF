		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="#">Reporte General de proveedores</a>
                </li>
			</ul>
                <?php if($security == 'go'){ ?>
                <h1>Reporte General de proveedores</h1>
                <div class="box-content">
						<form class="form-horizontal" action="r_finales_provee.php" method="post">
						  <fieldset>
                              <h2>Fecha</h2> <br>
							...
							<!-- <div class="control-group">
								...
								<div class="controls">
								  <select id="proveedor" name="proveedor" data-rel="chosen">
                                      <option value=""></option>
                                    <?php
                                      $query=mysql_query("SELECT * FROM `proveedores`");
                                      
                                      while($result_bancos=mysql_fetch_array($query)){
                                        $r=$result_bancos['id_proveedor'];
                                        $r2=$result_bancos['nombre_proveedor'];  
                                    ?>
                                      <option value="<?php echo "$r";?>-<?php echo "$r2";?>"><?php echo "$r2";?></option>
                                    <?php
                                      }
                                    ?>
