		...
		<?php
			...
			<div class="row-fluid">
				...
				<div class="span3 statbox black" onTablet="span6" onDesktop="span3">
					...
					<div class="title">Reporte General</div>
					<div class="footer">
						<a href="rep_cxc_general.php"> Ingresar</a>
					</div>	
				</div>
				<div class="span3 statbox pink" onTablet="span6" onDesktop="span3">
					<div class="boxchart">1,2,6,4,0,8,2,4,5,3,5</div>
					<div class="number"><i class="icon-arrow-up"></i></div>
                ...
                <div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
					...
					<div class="number"><i class="icon-arrow-up"></i></div>
					<div class="title">Estado de cuenta general</div>
					<div class="footer">
						<a href="#"> Ingresar</a>
					</div>
				</div>
