						  ...
						  <fieldset>
                            <div class="control-group">
                             ...
                             <label class=" control-label" for="no_documento">Comision: </label>
								...
								<input type="text" class="input-medium typeahead" placeholder="Escriba el porcentaje" id="porcen_comi" name="porcen_comi" value="" >
							  </div>   
								...
								<div class="controls">
								  <select id="vendedor" name="vendedor" data-rel="chosen">
                                      <option value=""></option>
                                    <?php
                                      $query1=mysql_query("SELECT `id_vendedor`,`nombre_vendedor` FROM `vendedores` ORDER BY id_vendedor ASC");
                                      
                                      while($r1=mysql_fetch_array($query1)){
                                        $id_vendedor  =  $r1['id_vendedor'];
                                        $nombre      =  $r1['nombre_vendedor'];
                                    ?>
                                      <option value="<?php echo "$id_vendedor";?>"><?php echo "$nombre";?></option>
                                    <?php
                                      }
                                    ?>
							...
							<div class="form-actions">
                                ...
                                echo "<h3>Comisión ingresada con éxito!</h3>";
                            }
                        ?>
					</div>
			<!-- TERMINA: CONTENIDO ************************************************************** -->
