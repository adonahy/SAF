		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    <a href="#">Bodega</a>
                    <i class="icon-angle-right"></i>
                    <a href="reporte_bodega.php">Reportes</a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Mínimos y Máximos</a>
                </li>
			</ul>
                <?php if($security == 'go'){?>
                <h1>Mínimos y Máximos</h1>
                <div class="box-content">
						<form class="form-horizontal" action="reporte_min_max.php" method="post">
						  <fieldset>
                              <h2>Fecha</h2> <br>
							...
							<div class="control-group">   
							  ...
							  <div class="controls">
								<input type="text" class="input-medium" id="codigo" name="codigo" value=""> 
							  </div>
							</div> 
