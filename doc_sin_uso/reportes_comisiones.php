...
<?php if($security == 'go'){ ?>
			<div class="row-fluid">
                ...
                <div class="span3 statbox black" onTablet="span6" onDesktop="span3">
					...
					<div class="title">Comisiones a pagar</div>
					<div class="footer">
						<a href="reporte_comision_pagar.php"> Ingresar</a>
					</div>
				</div>
                <div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
					<div class="boxchart">1,2,6,4,0,8,2,4,5,3,1,7,5</div>
					<div class="number"><i class="icon-arrow-up"></i></div>
					<div class="title">Comisiones totales</div>
					<div class="footer">
						<a href="reporte_comision_total.php"> Ingresar</a>
					</div>
				</div>
