		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="rep_cxc.php">Cuentas por cobrar</a>
                    <i class="icon-angle-right"></i>
                ...
                <div class="box-content">
						<form class="form-horizontal" action="reporte_cxc_general.php" method="post">
						  <fieldset>
                              <h2>Fecha</h2> <br>
                            <div class="control-group">   
							 ...
							 <div class="control-group">
								...
								<div class="controls">
								  <select id="documento" name="documento" data-rel="chosen">
                                      <option value=""></option>
                                      <option value="General">General</option>
								      <option value="Recibos">Recibos</option>
                                      <option value="Notas">Notas C.</option>
