		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="m_abonos.php">Mantenimiento de Notas</a>
                    <i class="icon-angle-right"></i>
                ...
                if(empty($_POST)===false && $_POST['flag1']=="next"){
                        ...
                        $query2     =   mysql_query("INSERT INTO `cxc_cabecera` (`id_cxc`, `id_cliente`, `fecha`, `valor_abono`, `no_recibo`, `no_deposito`, `banco`, `cuenta`, `serie`, `observaciones`,`tipo_docto`) VALUES (NULL, '$codigo_cliente', '$fecha', '', '$no_nota', '', '', '', '', '$ob','Nota')");
						  ...
						  <fieldset>
                              <table border="0" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="control-label" for="no_recibo">No. Nota Crédito: </label>
                                        <div class="controls">
								            <input type="text" class="input-medium typeahead" id="no_nota" name="no_nota">
							            </div>
                                ...
                                <tr>
                                    <td>
                                        <label class="control-label" for="no_deposito">Ref. Factura: </label>
                                        <div class="controls">
                           ...
                           table border="0" style="width:100%">
                                <tr>
                                    <td>
                                        <label class="control-label" for="codigo">CODIGO CLIENTE: </label>
                                        <div class="controls">
								            <input disabled type="text" class="input-medium typeahead" id="codigo" name="codigo" value="<?php ?>">
							            </div>
                                        <!--<label class="control-label" for="nombre_cliente">NOMBRE CLIENTE: </label>-->
                                        <div class="controls">
								            <input type="text" class="input-xlarge typeahead" id="nombre_cliente" name="nombre_cliente" placeholder="El nombre del cliente saldra automático!">
