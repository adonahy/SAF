		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="manto_lugar_entrega.php">Mantenimiento de lugares de entrega</a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Ingreso lugar de entrega</a>
                </li>
			</ul>
                <?php
                if($security == 'go'){
                if(empty($_POST)===false && empty($_POST['flag'])===false){
                        $des        =   $_POST['des'];
                    
                        $u          =   "Usuario Registrado";
                        $d          =   "Agrego un nuevo lugar de entrega: ";
                        $t          =   "lugar_entrega";
                        
                        $query=mysql_query("INSERT INTO `lugar_entrega` (`id_lugar`, `descripcion_lugar`) VALUES (NULL, '$des')");
                        
                        insert_logs($da, $u, $d, $t, $des);
                        echo "<h3>Lugar de entrega ingresado con éxito!</h3>";
                    }
                
                ?>
                <h1>Mantenimiento de Lugares de entrega</h1>
