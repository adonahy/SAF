		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="#">Pedidos Mayoreo</a>
                </li>
			</ul>
                <h1>Pedido Mayoreo</h1>
					...
					<div class="box-content">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tbody>
							<tr>
								<td>    
								<input type="text" class="span6 typeahead" id="codigo" name="codigo" >
                                </td>
								<td class="center">
                                    <input type="text" class="span6 typeahead" id="cantidad" name="cantidad" >
                                </td>
								<td class="center">
