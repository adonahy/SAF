		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="#">Ingreso cuentas por cobrar</a>
                </li>
			</ul>
                <?php
                if($security == 'go'){ 
                ...
                if(empty($_POST)===false && $_POST['flag1']=="guardar"){
                    ...
                    $nombre     =   $_POST['no_comercial'];
                    $descrip    =   $_POST['descripcion'];
                    $observ     =   "Cuentas por Cobrar - $no_docto";
                    
                    $query2 =   mysql_query("INSERT INTO `cxc_cabecera` (`id_cxc`, `id_cliente`, `fecha`, `saldo`, `no_recibo`, `archivo`, `no_deposito`, `banco`,`cuenta`,`serie`, `observaciones`,`tipo_docto`, `estatus`) VALUES (NULL, '$nombre', '$da' , '' ,'$no_docto', '$new_file_name', '', '','','$serie', '$observ', '', '1')");
                ...
                ?>
                <h1>Ingreso de cuentas por cobrar</h1>
						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
						  <fieldset>
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-medium datepicker" id="date01" name="date01" value="<?php echo $da; ?>" disabled>
							  </div>
                             ...
                             <label class=" control-label" for="no_documento">NO. de DOCUMENTO/PEDIDO: </label>
                                  <div class="controls">
                            <input type="text" class="input-medium typeahead" id="no_documento" name="no_documento" value="" >
							  </div><br>
                                                
                               <label class=" control-label" for="no_comercial">NOMBRE COMERCIAL: </label>
                                  <div class="controls">
								<select id="banco" name="banco" data-rel="chosen">
                                      <option value=""></option>
                                    <?php
                                      $query12 = mysql_query("SELECT * FROM `clientes`");
                                      
                                      while($result_clientes=mysql_fetch_array($query12)){
                                        $r=$result_clientes['codigo'];
                                        $r2=$result_clientes['nombre_comercial'];  
                                    ?>
							...
							<!--  <label class=" control-label" for="archivo">FOTO ARCHIVO: </label>
                              ...
                              <input type="file" name="archivo" id="archivo" size="25" />
                                ...
                                <label class=" control-label" for="descripcion">DESCRIPCION: </label>
                                  <div class="controls">
                                    <textarea name="Descripcion" rows="6" cols="10"></textarea>
							  </div>   
