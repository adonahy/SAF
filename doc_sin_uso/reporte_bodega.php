...
<?php if($security == 'go'){ ?>
			<div class="row-fluid">
				...
				<div class="span3 statbox green" onTablet="span6" onDesktop="span3">
					...
					<div class="footer">
						<a href="rep_bodega_kardex.php"> Ingresar</a>
					</div>	
				</div>
                <div class="span3 statbox blue" onTablet="span6" onDesktop="span3">
					<div class="boxchart">5,6,7,2,0,4</div>
					<div class="number"><i class="icon-arrow-up"></i></div>
					<div class="title">Mínimos y Máximos</div>
					<div class="footer">
						<a href="rep_min_max.php"> Ingresar</a>
					</div>	
				</div>
                <div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
					<div class="boxchart">3,6,7,2,1,2</div>
					<div class="number"><i class="icon-arrow-up"></i></div>
					<div class="title">Inventario General</div>
					<div class="footer">
						<a href="rep_bodega_general.php"> Ingresar</a>
					</div>	
				</div>
