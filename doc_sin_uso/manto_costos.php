		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    <a href="#">Costos</a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Mantenimiento de costos</a>
                </li>
			</ul>
                <?php if($security == 'go'){ ?>
            ...
            <div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                          <?php
                              $query_todo   =   mysql_query("SELECT `codigo`,`descripcion`,`costoxunidad` FROM `inventario_central` ORDER BY codigo DESC");
                              
                              while($search=mysql_fetch_array($query_todo)){
                                  $id_view  =   "C." . $search['codigo'];
                                  $id       =   $search['codigo'];
                                  $des      =   $search['descripcion'];
                                  $costo    =   $search['costoxunidad'];
                          ?>
							<tr>
								<td class="center"><?php echo "$id_view";?></td>
								<td class="center"><?php echo "$des";?></td>
                                <td class="center"><?php echo "$costo";?></td>
								<td class="center">
                                    <form name="this1" method="post" action="m_costos.php">
