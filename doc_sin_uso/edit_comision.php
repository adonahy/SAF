		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="manto_comision.php">Comisiones</a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Editar comisión</a>
                </li>
			</ul>
                <?php
                if($security == 'go'){ 
                ...
                if(empty($_POST)===false && $_POST['flag1']=="guardar"){
                    // if($_FILES['archivo']['name']){
                       ...
                       // }
                    $comision   =   $_POST['porcen_comi'];
                    //$serie      =   $_POST['serie'];
                    $id_vendedor =   $_POST['vendedor'];
                    $id          =   $_POST['control'];
                    
                    
                   // $query2 =   mysql_query("INSERT INTO `comision` (`id_comision`, `fecha`, `total_comision`, `vendedor`, `estatus`) VALUES (NULL, '$da', '$comision', '$id_vendedor', '0')");
                    
                     $query2 =   mysql_query("UPDATE `comision` SET `total_comision` = '$comision' WHERE CONCAT(`comision`.`id_comision`) = '$id'");
                    ...
                    <div class="box-content">
                        <?php
                            if($flag1=="one"){
                                ...
                                $querycon  =   mysql_query("SELECT `id_comision`, `fecha`, `total_comision`, `vendedor`, `estatus` FROM `comision` WHERE id_comision = '$id' ");
                                $rcon      =   mysql_fetch_array($querycon);
                                
                                $fecha_comision =   $rcon['fecha'];
                                $total_con      =   $rcon['total_comision'];
                                $vendedor       =   $rcon['vendedor'];
						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
						  <fieldset>
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-medium datepicker" id="date01" name="date01" value="<?php echo $fecha_comision; ?>" disabled>
							  </div>
                             <label class=" control-label" for="no_documento">Comision: </label>
                                  <div class="controls">
                                      
								<input type="text" class="input-medium typeahead"  id="porcen_comi" name="porcen_comi" value="<?php echo $total_con; ?>" >
							  </div>   
                                                                
								<label class="control-label" for="cliente">Vendedor: </label>
								<div class="controls">
								  <input type="text" class="input-medium typeahead" id="vendedor" name="vendedor" value="<?php echo $vendedor; ?>" disabled >
								</div>
							...
							<div class="form-actions">
                                ...
                                echo "<h3>Comisión Editado con éxito!</h3>";
                            }
                        ?>
					</div>
			<!-- TERMINA: CONTENIDO ************************************************************** -->
