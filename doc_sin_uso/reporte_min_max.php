...
if($codigo!=""){
    $query  =   mysql_query("SELECT `codigo`,`descripcion`,`cantidad`,`min`,`max` FROM `inventario_central` WHERE codigo = '$codigo'");
    $codigo_view =  $codigo;
}else{
    $query  =   mysql_query("SELECT `codigo`,`descripcion`,`cantidad`,`min`,`max` FROM `inventario_central` ORDER BY codigo ASC");
    $codigo_view =  "TODOS";
}
						  ...
						  <fieldset>
							  <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="input-medium datepicker" id="date01" name="date01" value="'. $del .'">
                                    </td>
                                </tr>
								<tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="input-medium" id="codigo" name="codigo" value="'. $codigo_view .'">
                                    </td>
                                </tr>
...
$mpdf->Output('Reporte_mínimo_máximo.pdf', 'D');
