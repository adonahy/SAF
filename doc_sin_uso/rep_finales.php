	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>ST System</span></a>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    <a href="#">Ventas</a>
                    <i class="icon-angle-right"></i>
                    <a href="reportes_ventas.php">Reportes</a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Reporte de pedidos finales</a>
                </li>
			</ul>
                <?php if($security == 'go'){ ?>
                <h1>Reporte de pedidos finales</h1>
                <div class="box-content">
						<form class="form-horizontal" action="r_finales.php" method="post">
						  <fieldset>
                              <h2>Fecha</h2> <br>
