...
?>
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="#">Reporte comisiones totales</a>
                </li>
			</ul>
                <?php if($security == 'go'){ ?>
                <h1>Reporte comisiones totales </h1>
                <div class="box-content">
						<form class="form-horizontal" action="r_finales_comision_totales.php" method="post">
						  <fieldset>
                              <h2>Fecha</h2> <br>
                            <div class="control-group">   
							 ...
							 <div class="control-group">
								...
								<div class="controls">
								  <select id="vendedor" name="vendedor" data-rel="chosen" onmouseup="alert('You are clicking on me');" >
                                      <option value=""></option>
                                    <?php
                                      $query=mysql_query("SELECT * FROM `vendedores`");
                                      
                                      while($result_bancos=mysql_fetch_array($query)){
                                        $r=$result_bancos['id_vendedor'];
                                        $r2=$result_bancos['nombre_vendedor'];  
                                    ?>
