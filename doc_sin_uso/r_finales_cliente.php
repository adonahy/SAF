...
$query  = mysql_query("SELECT `id_control`,`fecha`,`no_docto`,`serie`,`cliente`,`total`,`saldo` FROM `cxc` WHERE fecha >= '$del' AND fecha <= '$al' AND  cliente = '$idcliente' ");
...
$query3 = mysql_query("SELECT `id`,`control`,`cantidad`,`no_doc`,`forma_pago`,`fecha` FROM `cxc_abonos` WHERE control = '$idcxc' ");
			...
			<div id="content" class="span10">
                ...
                <div class="box-content">
						<form class="form-horizontal">
						  <fieldset>
                           <h1>Reporte de cliente '. $cliente_nombre . '</h1>   
...
$mpdf->Output('Reporte por Clientes.pdf', 'D');
