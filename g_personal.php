		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    <a href="#"> Gastos </a>
                    <i class="icon-angle-right"></i>
                    <a href="manto_gastos_adici.php"> Gastos adicionales </a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Ingreso de Gastos adicionales</a>
                </li>
			</ul>
                <?php
                if($security == 'go'){ 
                ...
                if(empty($_POST)===false && $_POST['flag1']=="guardar"){
                    ...
                    $query2 =   mysql_query("INSERT INTO `gastos_adicionales` (`id_gastos`, `fecha`, `descripcion`, `lugar`, `forma_pago`, `banco`, `monto`) VALUES (NULL, '$da', '$descrip', '$lugar', '$fpago', '$bancotodo', '$total')");
                ...
                ?>
                <h1>Ingreso gastos adicionales</h1>
						  ...
						  <fieldset>
                            <div class="control-group">
                             ...
                             <label class=" control-label" for="no_documento">LUGAR: </label>
                                ...
                                <label class=" control-label" for="serie">DESCRIPCION: </label>
                                  <div class="controls">
                                      
								<input type="text" class="input-xlarge typeahead" id="descrip" name="descrip" value="">
							  </div> 
