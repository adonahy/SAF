		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    <a href="#"> Gastos </a>
                    <i class="icon-angle-right"></i>
                    <a href="#">Gastos adicionales</a>
                </li>
			</ul>
                <?php if($security == 'go'){ ?>
                <!--INICIA TABLA DE MANTENIMIENTO------------------------------------->
                <h1>Mantenimiento de Gastos Adicionales</h1>
            <div class="box-content">
                <table>
                    <tr>
                        <td>
                            <form name="this2" method="post" action="g_personal.php">
                    <button type="submit" class="btn btn-info"><i class="glyphicons-icon white circle_plus">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gasto</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                        ...
                        //    }
                             ...
                             $query_todo    =   mysql_query("SELECT `id_gastos`, `fecha`, `descripcion`, `lugar`, `forma_pago`, `banco`, `monto`  FROM `gastos_adicionales`  ORDER BY id_gastos DESC");
