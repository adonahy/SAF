		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="#">Reportes de Lista de Alumnos</a>
                </li>
			</ul>
                <?php if($security == 'go'){ ?>
                <h1>Reportes de Lista de Alumnos</h1>
                <div class="box-content">
						<form class="form-horizontal" action="r_finales_proveetodo.php" method="post">
						  <fieldset>
                              <!--<h2>Fecha</h2> <br>
                            <div class="control-group">   
							 ...
							 <div class="control-group">
								<label class="control-label" for="curso">Cusos: </label>
								<div class="controls">
								  <select id="curso" name="curso" data-rel="chosen">
                                      <option value=""></option>
                                      <option value="0">Todo</option>
                                    <?php
                                      $query=mysql_query("SELECT * FROM `cursos`");
                                      
                                      while($result_bancos=mysql_fetch_array($query)){
                                        $r=$result_bancos['id_curso'];
                                        $r2=$result_bancos['nombre_curso'];  
                                    ?>
