...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
            ...
            <div class="row-fluid sortable">	<!-- START ROW FLUID!!!!!!!!!-->	
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon info-sign"></i><span class="break"></span>Historial</h2>
						<div class="box-icon">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable">
						  <thead>
							  <tr>
								  ...
								  <th>Tabla a la que afecto dicha acción</th>
							  </tr>
						  </thead>   
						  <tbody>
                              <?php
