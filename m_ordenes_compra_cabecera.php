...
<script type="text/javascript">    
    function search(codigo,name,precio,precio1)
       {
          var xmlhttp_name;
          var xml_precio;
          ...
          {// code for IE7+, Firefox, Chrome, Opera, Safari
            ...
            xml_precio=new XMLHttpRequest();  
          }
          else
          {// code for IE6, IE5
            xmlhttp_name=new ActiveXObject("Microsoft.XMLHTTP");
            xml_precio=new ActiveXObject("Microsoft.XMLHTTP");
          }	
          ...
          xmlhttp_name.onreadystatechange = function() {
            if(xmlhttp_name.readyState == 4 && xmlhttp_name.status == 200)
            {
              //document.getElementById("des").value = xmlhttp.responseText;
                document.getElementById(name).innerHTML = xmlhttp_name.responseText;
                
            }
          }
            xml_precio.onreadystatechange = function() {
            if(xml_precio.readyState == 4 && xml_precio.status == 200)
            {
              //document.getElementById("des").value = xmlhttp.responseText;
                document.getElementById(precio).innerHTML = xml_precio.responseText;
                document.getElementById(precio1).value = xml_precio.responseText;
                
            }
          }

          xmlhttp_name.open("GET","search_orden.php?codigo="+codigo, true);
          xmlhttp_name.send();
          xml_precio.open("GET","search_precio.php?codigo="+codigo, true);
          xml_precio.send();
                     ...
                     <div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          ?>
							<tr>
								<td class="center">
                                    <input  type="text" class="input-small typeahead" id="<?php echo "$name_cod";?>" name="<?php echo "$name_cod";?>" onkeyup="search(this.value,'<?php echo "$name_des";?>','<?php echo "$name_costo1";?>','<?php echo "$name_costo";?>');">
                                </td>
								<td class="center">
                                ...
                                <td class="center">
                                    ...
                                    <font color="green"><span id="<?php echo "$name_costo1";?>" name="<?php echo "$name_costo1";?>"></span></font>
                                
                                    <input type="hidden" class="input-small typeahead" id="<?php echo "$name_costo";?>" name="<?php echo "$name_costo";?>" onkeyup="sum_tot(this.value,'<?php echo "$name_cantidad";?>','<?php echo "$name_total";?>');">
