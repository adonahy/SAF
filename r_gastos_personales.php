...
$query  = mysql_query("SELECT `id_gastos`,`fecha`,`descripcion`,`forma_pago`,`lugar`,`banco`,`monto` FROM `gastos_adicionales` WHERE  fecha >= '$del' AND fecha <= '$al' ");
while($r      = mysql_fetch_array($query)){

$fecha      = $r['fecha'];
$idgastos   = $r['id_gastos'];
			...
			<div id="content" class="span10">
                ...
                <div class="box-content">
						<form class="form-horizontal">
						  <fieldset>
                           <h1>Reporte de gastos personales </h1>   
...
$mpdf->Output('gastos_Personales.pdf', 'D');
