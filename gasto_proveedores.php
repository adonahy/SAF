	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
                ...
                ?>
                <h1>Ingreso gasto proveedores</h1>
                             ...
                             <label class=" control-label" for="no_documento">NO. DOCUMENTO: </label>
								...
								<div class="controls">
								  <select id="proveedor" name="proveedor" data-rel="chosen">
                                    <?php
                                      $query1=mysql_query("SELECT `id_proveedor`,`nombre_proveedor` FROM `proveedores` ORDER BY id_proveedor ASC");
                                      
                                      while($r1=mysql_fetch_array($query1)){
                                        $id_proveedor=$r1['id_proveedor'];
                                        $nombre      =$r1['nombre_proveedor'];
                                    ?>
