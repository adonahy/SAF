	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<?php
                ...
                $query      =   mysql_query("INSERT INTO `egreso_planilla` (`id`, `inicio`, `fin`, `empleado`, `monto`, `razon`, `banco`, `cuenta`) VALUES (NULL, '$inicio', '$fin', '$empleado', '$monto', '$razon', '$banco', '$cuenta')");
                 $fecha  =   date("m/d/Y");
                 ...
                 $query2     =   mysql_query("INSERT INTO `estados_cuenta` (`id`, `fecha`, `no_docto`, `concepto`, `credito`, `debito`, `saldo`, `banco`, `cuenta`) VALUES ('NULL', '$fecha', '', '$razon', '$monto', '', '', '$banco','$cuenta')");
                    ...
                    $d      =   "Efectuo un egreso de planilla, al empleado con ID: " . "$empleado por un monto de: ";
                    $t      =   "egreso_planilla";
							  ...
							  <div class="controls">
								...
								<div class="controls">
								  <select name="empleado" id="empleado" data-rel="chosen">
                                      <option value=""></option>
                                    <?php
                                      $query=mysql_query("SELECT `id`,`nombre_1`,`ape_1` FROM `planillas`");
                                ...
                                <label class="control-label" for="monto">Monto descuento: </label>
                                  <div class="controls">
								<input type="text" class="span6 typeahead" id="monto" name="monto" placeholder="No ingresar moneda, solo el monto...">
							  </div><br>
                                <label class="control-label" for="razon">Razon: </label>
								<div class="controls">
								  <select id="razon" name="razon" data-rel="chosen">
									<option value="Compras">Compras</option>
                                    <option value="Prestamos Internos">Prestamos Internos</option>
                                    <option value="Prestamos Externos">Prestamos Externos</option>
                                    <option value="IRTRA e IGSS">IRTRA e IGSS</option>
